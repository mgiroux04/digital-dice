...
A hardware proof-of-concept for a digital dice built on the TM4C123GH6PM microcontroller. Press a button, get a random roll,  displayed instantly via onboard LEDs.
...
- Depending on the switch pressed, a number 1-4 or 1-6 is generated 
